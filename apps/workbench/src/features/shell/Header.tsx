...
export function Header() {
  ...
  return (
    <header className="top sticky top-0 z-30 flex h-14 shrink-0 w-full items-center justify-between border-b border-border bg-surface/95 px-3 sm:px-6 backdrop-blur-sm">
      ...
      <div className="top__actions shrink-0 flex items-center gap-1 sm:gap-2">
        ...
        {/* Undo / Redo; touch controls also live in the custom-group panel. */}
